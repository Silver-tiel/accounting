<?php
$activePage = 'home';
$pageTitle = 'Kantor Akuntan Publik Ishak Awaluddin';
$pageDescription = 'Menyajikan Layanan Audit Independen dan Profesional demi Keandalan Laporan Keuangan serta Kepatuhan terhadap Standar Akuntansi';
